...
//images articles
import article3 from "../../public/images/articles/article 3.jpg";
...
const Article = ({ img, title, date, link }) => {
  return (
    <motion.li
      ...
      // viewport once true permet qu'une fois le scroll event joué il ne se rejoue pas
      viewport={{ once: true }}
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Face Nord Graphisme | Blog</title>
      ...
      >
        <Layout className="pt-16">
          <AnimatedText
            text="Les Derniers Articles Du Blog"
